    ...
    F: Fn() -> R,
{
    ...
    #[inline]
    fn apply(&self, _args: ()) -> Self::Output {
        (*self)()
    }
}
...
macro_rules! generics {
    ($type:ident) => {
            ...
            F: Fn($type) -> R,
        {
            ...
            #[inline]
            fn apply(&self, args: Product!($type)) -> Self::Output {
                (*self)(args.0)
            }
            ...
            F: Fn($type) -> R,
        {
            ...
            #[inline]
            fn apply(&self, args: ($type,)) -> Self::Output {
                (*self)(args.0)
            }
        }
    ...
    ($type1:ident, $( $type:ident ),*) => {
            ...
            F: Fn($type1, $( $type ),*) -> R,
        {
            ...
            #[inline]
            fn apply(&self, args: Product!($type1, $($type),*)) -> Self::Output {
                #[allow(non_snake_case)]
            ...
            F: Fn($type1, $( $type ),*) -> R,
        {
            ...
            #[inline]
            fn apply(&self, args: ($type1, $($type),*)) -> Self::Output {
                #[allow(non_snake_case)]
                let ($type1, $( $type ),*) = args;
                (*self)($type1, $( $type ),*)
            }
